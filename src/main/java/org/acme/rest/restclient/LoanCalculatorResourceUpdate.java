...
@Path("/qualification-check-v2")

public class LoanCalculatorResourceUpdate {
    ...
    public ResultObj postCase(String json) {
        ...
        try {
            ...
            System.out.println("In the new service");
            ...
            Log.info("You are in the new service");
             String response = onboardingService.checkQualNew(dmnReq);

            Log.info("The reponse is: " + response);
